...
if (analyticsConfiguration.syncAllContacts()) {
	...
	String[] syncedOrganizationIdsArray = analyticsConfiguration.syncedOrganizationIds();
	...
	String[] syncedUserGroupIdsArray = analyticsConfiguration.syncedUserGroupIds();
